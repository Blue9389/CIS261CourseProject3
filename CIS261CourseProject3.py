...
def write_Employees(Employees):
    with open(FILENAME, "w") as file:
        for Emplloyees in Employees:
            file_write(f"{Employees}\n")
def GetEmpName():
...
if __name__ == "__main__":
        ...
        with open("FILENAME", "a") as EmpFile:
            ...
            while True:
                ...
                EmpDetsil = fromdate + "|" + todate + "|" + empname + "|" + hours + "|" + hourlyrate + "|"
                + str(taxrate) + "\n"
                # write the line of code that will write EmpDetail to the file
                EmpFile.wrte(EmpDetail)
